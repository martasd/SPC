...
typedef struct FunctionProcedureType FunctionProcedureType;
...
/* We need to store parameters with functions and procedures. If we are
 * dealing with a procedure, then we set return type to NULL.
 */
struct FunctionProcedureType
{
  Param *params;
  Type *return_val;
  int num_params;
...
struct Type
{
  ...
  {
    ArrayType *array;
    FunctionProcedureType *function_procedure;
    RecordType *record;
    ScalarType *scalar;
